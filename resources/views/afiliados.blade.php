...
<section>
    <div class="container">
        <div class="row">
            <h2 class="text-center"><span>Maneras de afiliarte a esta pagina</span>Creado con el <i class="fa fa-heart"></i> de Dogsi Admin</h2>
      ...
      <div class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseOne" class="collapsed">
          <i class="fa fa-file-text-o" aria-hidden="true"></i>
            ...
            <p>Los productos de mascotas al por mayor nos interesan para agrandar nuestro catálogo.</p>
        </a>
        <i class="fa fa-angle-right" aria-hidden="true"></i>
      </div>
    </div>
