...
@section('content')
    <div class="container mt-5">
        ...
        <section class="cta aos-init aos-animate" data-aos="fade-up" data-aos-delay="0">
            <div class="container">
                <div class="cta-content d-xl-flex align-items-center justify-content-around text-center text-xl-left">
                    ...
                    <div class="subscribe-btn aos-init aos-animate" data-aos="fade-left" data-aos-delay="400"
                        data-aos-offset="0">
        ...
        <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action badge-primary bg-primary shadow-sm rounded">
