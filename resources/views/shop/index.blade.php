...
<header>
    ...
    <!--Carousel Wrapper-->
    <div id="carousel-example-2" data-interval="false" class="carousel  carousel-fade mt-5">
        <!--Indicators-->
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <div class="view">
                    <img class="d-block w-100" src="img\esteriliza.jfif"
                        alt="First slide">
                     <div class="mask rgba-black-light"></div> 
                </div>
                <div class="carousel-caption">
                    <h3 class="h3-responsive">Conoce los benecificios de esterilizar a tu mascota.</h3>
                    <p></p>
                </div>
            </div>
           ...
           <div class="carousel-item">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h3 class="h3-responsive">Collar antipulgas y garrapatas para perros</h3>
                    <!-- <p>Third text</p> -->
                </div>
            </div>
        </div>
