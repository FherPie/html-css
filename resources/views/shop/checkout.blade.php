                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nombres" class="form-control"
                                    value="{{ Session::has('clientePotencial') ? Session::get('clientePotencial')->name :  old('nombres') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="celular" class="form-control"
                                    value="{{ Session::has('clientePotencial') ? Session::get ('clientePotencial')->celular:  old('celular') }}"
                                        ...
                                        <div class="card-header" role="tab" id="heading{{ $forma->id }}">
                                            <div class="form-check">
                                                ...
                                                <input data-toggle="collapse" href="#collapse{{ $forma->id }}"
                                                    ...
                                                    name="formaPago" {{ old('formaPago') == $forma->id ? 'checked' : '' }}>
