                        ...
                        <dd>Orange color</dd>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{ route('producto.addToCartCheckOut', ['id' => $producto['item']->id_producto]) }}"
                                                    class="btn btn-outline-danger btn-round"><i class="fa fa-plus"></i> </a>
                                                <a href="{{ route('producto.reduceToCartCheckOut', ['id' => $producto['item']->id_producto]) }}"
                                        ...
                                        <td>
                                            <div class="price-wrap">
                                                <var class="price">USD
                                                    {{ number_format($producto['item']['precio_referencial_venta'], 2, '.', ',') }}</var>
                                        ...
                                        <td>
                                            <div class="price-wrap">
                                                <var class="price">USD
                                                    {{ number_format($producto['item']['precio_referencial_venta'] * $producto['qty'], 2, '.', ',') }}</var>
                                            </div> <!-- price-wrap .// -->
                                        </td>
