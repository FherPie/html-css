...
<head>
    ...
    <script
        src="https://www.paypal.com/sdk/js?client-id=Abb7r6AIWPxDcVak86PdAm1T8DPX5zkvu_vI8xvrLx7dUk8xbNretFjOmExxb160C5XlXiJ0HzLb59Tj">
...
<body>
    ...
    <!-- </aside> -->
    <div class="mt-5" data-aos="fade-down" data-aos-delay="0">
        @yield('content')
    </div>
    <script 
